 ...
 *
 * This script generates old-style route instructions directly from
 * NavigationPathManager path corners and can call an external audio/TTS process.
 *
 * It is separate from the current V4 decision-node guide flow. Current V4 route
 * text is generated by NavigationGuideTextGenerator, which consumes DecisionNode
 * data from NavigationDecisionSystem.
 *
 * Unless you are still using NavigationPathManager-based instructions elsewhere,
 * do not attach this to V4_HumanVerbalGuide.
 */
