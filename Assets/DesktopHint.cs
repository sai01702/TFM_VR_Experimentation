...
public class DesktopHint : MonoBehaviour
{
    ...
    void SetupLabel()
    {
        ...
        // Don't overwrite TMP when a localization component drives this label
        if (label != null)
        {
            bool localized =
                label.GetComponent<LocalizeStringEvent>() != null
                || label.GetComponentInParent<LocalizeStringEvent>() != null;
            if (!localized)
